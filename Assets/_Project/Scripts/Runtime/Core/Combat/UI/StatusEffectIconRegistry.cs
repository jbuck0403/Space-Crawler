...
//     {
//         // Direct matching for exact effect names
//         if (effectID == "Freezing")
//         {
//             return (StatusEffect.Freezing, null);
//         }

//         // Handle burning effect patterns (legacy support)
...
//         // Try direct enum parsing as a fallback
//         if (System.Enum.TryParse(effectID, out StatusEffect effect))
//         {
//             return (effect, null);
//         }

//         // Return sensible default with warning
//         Debug.LogWarning($"StatusEffectIconRegistry: Unknown effect ID format: {effectID}");
